        ...
        <div class="checkout-right">
            <table class="timetable_sub">
                ...
                <tr class="rem1">
                    ...
                    <td class="invert-image"><a href="single.html"><img src="page/images/j3.jpg" alt=" " class="img-responsive" /></a></td>
                    <td class="invert">
                        <div class="quantity">
                ...
                <tr class="rem2">
                    ...
                    <td class="invert-image"><a href="single.html"><img src="page/images/ss5.jpg" alt=" " class="img-responsive" /></a></td>
                    <td class="invert">
                        <div class="quantity">
                            <div class="quantity-select">
                                <div class="entry value-minus">&nbsp;</div>
                ...
                <tr class="rem3">
                    ...
                    <td class="invert-image"><a href="single.html"><img src="page/images/c7.jpg" alt=" " class="img-responsive" /></a></td>
                    <td class="invert">
                        <div class="quantity">
                            <div class="quantity-select">
                                <div class="entry value-minus">&nbsp;</div>
        ...
        <ul id="flexiselDemo2">
            ...
            <li>
                <div class="w3l_related_products_grid">
                    <div class="agile_ecommerce_tab_left dresses_grid">
                        <div class="hs-wrapper hs-wrapper3">
                            <img src="page/images/ss4.jpg" alt=" " class="img-responsive">
                            <img src="page/images/ss5.jpg" alt=" " class="img-responsive">
                            <img src="page/images/ss6.jpg" alt=" " class="img-responsive">
                            <img src="page/images/ss7.jpg" alt=" " class="img-responsive">
                            <img src="page/images/ss8.jpg" alt=" " class="img-responsive">
                            <img src="page/images/ss9.jpg" alt=" " class="img-responsive">
                            <img src="page/images/ss1.jpg" alt=" " class="img-responsive">
                            <img src="page/images/ss2.jpg" alt=" " class="img-responsive">
                            <div class="w3_hs_bottom">
                                <div class="flex_ecommerce">
                                    <a href="#" data-toggle="modal" data-target="#myModal6"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
                                </div>
            ...
            <section>
                <div class="modal-body">
                    <div class="col-md-5 modal_body_left">
                        <img src="page/images/39.jpg" alt=" " class="img-responsive" />
                    </div>
